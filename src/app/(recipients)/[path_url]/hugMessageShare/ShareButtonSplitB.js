...
const ShareButtonSplitB = ({
  ...
  return (
    <div
      className={
        'flex rounded-[10px] shadow-custom2 border-[3px] border-primary pt-2 px-[15px] pb-[6px] justify-center items-center bg-white cursor-pointer w-[176px] relative'
      }
...
export default ShareButtonSplitB
