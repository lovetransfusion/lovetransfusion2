...
const TitleSection = () => {
  return (
    <div
      className={
        'flex pt-10 pb-[33px] md:pt-[78px] md:pb-[72px] w-full absolute'
      }
    >
      <div
        className={
          'container md:px-6 lg:px-10 xl:px-0 flex flex-col items-center  gap-[18px] z-10'
        }
      >
        ...
        <h1
          className={'font-mediumCond text-[40px] md:text-[54px] text-primary'}
        >
          Welcome to Benny’s Page!
        </h1>
      </div>
      <Image
        src={bgImageDesktop}
